...
<form action="" method="post">
    <table class="table table-bordered table-hover">
        ...
        <tbody>
        <?php
            //Combine posts and categories, left join categories to posts.
            //Both posts.category_id and category.cat_id are the same
            ...
            while($row = mysqli_fetch_assoc($select_posts)) {
                ...
                echo "<td><img width='100' src='../images/{$post_image}' alt='Image of post'></td>";
